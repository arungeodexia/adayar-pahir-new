...
//
//     String url =
//         '${AppStrings.BASE_URL}api/v1/chat/group/notification/org/${createEditProfileModel.universityId}/group/$peerId/user/${createEditProfileModel.id}';
...
//     // make POST request
//     var response = await client.post(url, headers: headers, body: json);
...
//         .collection('chatlist')
//         .document(widget.selectedUserID)
//         .get()
//         .then((value) {
//       print(value.exists);
//       if (value.exists) {
